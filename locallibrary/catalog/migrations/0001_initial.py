# Generated by Django 3.0.4 on 2020-03-10 04:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter the natural language of the book (e.g. English, Vietnamese, etc.)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
